...
def _utc(year: int, month: int, day: int, hour: int = 0, minute: int = 0) -> datetime:
    # Explicit params (not *args) so a future 6th/7th/8th positional value
    # can't silently collide with the tzinfo= kwarg below — datetime's own
    # 8th positional parameter *is* tzinfo.
