...
| [0011](0011-vps-staging-deployment.md) | Deployment automático a staging en VPS propio: bundle firmado por SHA sobre SSH restringido, frontera de seguridad fija, imágenes inmutables en GHCR | Fase 4.6 | Aceptado |
